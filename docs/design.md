...
- The tool stores OCR text, spatial observations, and derived signals locally in SQLite.
...
2. `wsa capture --contact NAME` captures the frontmost window, OCRs it with macOS Vision, and stores both clean text and structured observations.
